...
Bitmap.prototype._requestImage = function (url) {
    ...
    if (Decrypter.hasEncryptedImages && !Decrypter.checkImgIgnore(url)) {
...
Window.prototype._refreshCursor = function () {
    ...
    //    this._windowCursorSprite.bitmap = ImageManager.loadPicture('Choice1');
...
Decrypter._ignoreList = [
    "dragonbones_assets/zeograth_tex.png",
    "dragonbones_assets/spectalartgluttony_tex.png",
    "dragonbones_assets/contiturtle_tex.png",
    "dragonbones_assets/shlimerecolour2_tex.png",
    "dragonbones_assets/crystprotectordevil_tex.png",
    "dragonbones_assets/demeres_tex.png",
    "dragonbones_assets/throne_tex.png",
    "dragonbones_assets/judgement_tex.png",
    "dragonbones_assets/lilsuccubuspumpkinlover_tex.png",
    "dragonbones_assets/blastwaspcyberwaspbeta_tex.png",
    "dragonbones_assets/sumobeetledunebug_tex.png",
    "dragonbones_assets/mermaidwarrior_tex.png",
    "dragonbones_assets/gremlinsultan_tex.png",
    "dragonbones_assets/cplant_tex.png",
    "dragonbones_assets/daidarabotchi_tex.png",
    "dragonbones_assets/blastwaspdunebuzzerbeta_tex.png",
    "dragonbones_assets/nekomata_tex.png",
    "dragonbones_assets/wildbeaststormclaw_tex.png",
    "dragonbones_assets/slimecaster_tex.png",
    "dragonbones_assets/bonemask_tex.png",
    "dragonbones_assets/fungoliath_tex.png",
    "dragonbones_assets/suprisespookpotted_tex.png",
    "dragonbones_assets/celestialbreakeranubis_tex.png",
    "dragonbones_assets/runicstonegolem_tex.png",
    "dragonbones_assets/mythicalstag_tex.png",
    "dragonbones_assets/harpy_tex.png",
    "dragonbones_assets/shaccaddestroyer_tex.png",
    "dragonbones_assets/acolyteeye_tex.png",
    "dragonbones_assets/sharkmanhammer_tex.png",
    "dragonbones_assets/sentrybotpostbot_tex.png",
    "dragonbones_assets/skxoer_tex.png",
    "dragonbones_assets/onilingronin_tex.png",
    "dragonbones_assets/yurei-chan_tex.png",
    "dragonbones_assets/blastwaspcyberwaspalpha_tex.png",
    "dragonbones_assets/grunt_tex.png",
    "dragonbones_assets/minecactus_tex.png",
    "dragonbones_assets/spriggandeath_tex.png",
    "dragonbones_assets/kingarchial_tex.png",
    "dragonbones_assets/iceyeti_tex.png",
    "dragonbones_assets/suprisespookstumpy_tex.png",
    "dragonbones_assets/fireangel_tex.png",
    "dragonbones_assets/lilsuccubuspumpkinhead_tex.png",
    "dragonbones_assets/specrtralknightwrath_tex.png",
    "dragonbones_assets/tantalus_tex.png",
    "dragonbones_assets/wildbeastnightmane_tex.png",
    "dragonbones_assets/ignis_tex.png",
    "dragonbones_assets/remment_tex.png",
    "dragonbones_assets/garm_tex.png",
    "dragonbones_assets/dragongodgalacticdragon_tex.png",
    "dragonbones_assets/blastwaspdunebuzzeralpha_tex.png",
    "dragonbones_assets/rafflesia_tex.png",
    "dragonbones_assets/shaccad_tex.png",
    "dragonbones_assets/sidhecelestia_tex.png",
    "dragonbones_assets/oniling_tex.png",
    "dragonbones_assets/huanglong_tex.png",
    "dragonbones_assets/demon_tex.png",
    "dragonbones_assets/succubus_tex.png",
    "dragonbones_assets/arcanegolem_tex.png",
    "dragonbones_assets/colossalcrow_tex.png",
    "dragonbones_assets/astralich_tex.png",
    "dragonbones_assets/cryptbladereaper_tex.png",
    "dragonbones_assets/sharkmanjaws_tex.png",
    "dragonbones_assets/shlimerecolour3_tex.png",
    "dragonbones_assets/inugami_tex.png",
    "dragonbones_assets/mineanchor_tex.png",
    "dragonbones_assets/wingedserpentquetzalcoatl_tex.png",
    "dragonbones_assets/antqueen_tex.png",
    "dragonbones_assets/magmadragon_tex.png",
    "dragonbones_assets/shlime_tex.png",
    "dragonbones_assets/jubokko_tex.png",
    "dragonbones_assets/lightdragon_tex.png",
    "dragonbones_assets/seadragon_tex.png",
    "dragonbones_assets/meltera_tex.png",
    "dragonbones_assets/baba_tex.png",
    "dragonbones_assets/clockworkknightd_tex.png",
    "dragonbones_assets/highdragon_tex.png",
    "dragonbones_assets/wildbeastfrostmane_tex.png",
    "dragonbones_assets/zefir_tex.png",
    "dragonbones_assets/midas_tex.png",
    "dragonbones_assets/thanatos_tex.png",
    "dragonbones_assets/sprigganlife_tex.png",
    "dragonbones_assets/spectalartenvy_tex.png",
    "dragonbones_assets/wraith_tex.png",
    "dragonbones_assets/cryptbladepharaoh_tex.png",
    "dragonbones_assets/djinnifrit_tex.png",
    "dragonbones_assets/blastwaspkillerbeebeta_tex.png",
    "dragonbones_assets/weretiger_tex.png",
    "dragonbones_assets/phoenix_tex.png",
    "dragonbones_assets/insectqueen_tex.png",
    "dragonbones_assets/hades_tex.png",
    "dragonbones_assets/ancientautomaton_tex.png",
    "dragonbones_assets/pizarro_tex.png",
    "dragonbones_assets/poseidon_tex.png",
    "dragonbones_assets/harbinger_tex.png",
    "dragonbones_assets/dreamslime_tex.png",
    "dragonbones_assets/zidhe_tex.png",
    "dragonbones_assets/championgoblin_tex.png",
    "dragonbones_assets/urmica_tex.png",
    "dragonbones_assets/shlimerecolour1_tex.png",
    "dragonbones_assets/sidhetitania_tex.png",
    "dragonbones_assets/maskeddevil_tex.png",
    "dragonbones_assets/phantomknight_tex.png",
    "dragonbones_assets/radulac_tex.png",
    "dragonbones_assets/blastwaspkillerbeealpha_tex.png",
    "dragonbones_assets/kasaobake_tex.png",
    "dragonbones_assets/oozemetallic_tex.png",
    "dragonbones_assets/terraos_tex.png",
    "dragonbones_assets/dragongodcelestialdragon_tex.png",
    "dragonbones_assets/spectalartmirror_tex.png",
    "dragonbones_assets/sumobeetlecrystalbug_tex.png",
    "dragonbones_assets/clockworkking_tex.png",
    "dragonbones_assets/flynn_tex.png",
    "dragonbones_assets/wildbeastboltclaw_tex.png",
    "dragonbones_assets/ankylosaur_tex.png",
    "dragonbones_assets/horde_tex.png",
    "dragonbones_assets/alfadriel_tex.png",
    "dragonbones_assets/shlimerecolour4_tex.png",
    "dragonbones_assets/parrotking_tex.png",
    "dragonbones_assets/suprisespookbarrel_tex.png",
    "dragonbones_assets/hundred_tex.png",
    "dragonbones_assets/ilnoct_tex.png",
    "dragonbones_assets/zalaras_tex.png",
    "dragonbones_assets/kitsune_tex.png",
    "dragonbones_assets/wingedserpenthellviper_tex.png",
    "dragonbones_assets/slimedefender_tex.png",
    "dragonbones_assets/acolytecryst_tex.png",
    "dragonbones_assets/slitherytrickstershaman_tex.png",
    "dragonbones_assets/clockworkprototype_tex.png",
    "dragonbones_assets/clockworkskull_tex.png",
    "dragonbones_assets/crystprotectorangelic_tex.png",
    "dragonbones_assets/sumobeetleladybug_tex.png",
    "dragonbones_assets/celestialbreakerhorus_tex.png",
    "dragonbones_assets/zodiacaries_tex.png",
    "dragonbones_assets/minecactusaxe_tex.png",
    "dragonbones_assets/bloodmage_tex.png",
    "dragonbones_assets/specrtralknightpride_tex.png",
    "dragonbones_assets/celestialguardhorus_tex.png",
    "dragonbones_assets/wildbeastdaymane_tex.png",
    "dragonbones_assets/slitherytricksterjester_tex.png",
    "dragonbones_assets/celestialguardanubis_tex.png",
    "dragonbones_assets/gremlinwizard_tex.png",
    "dragonbones_assets/sentinelrevamp_tex.png",
    "dragonbones_assets/boundspiritaquarius_tex.png",
    "dragonbones_assets/leviathanseaking_tex.png",
    "dragonbones_assets/regulus_tex.png",
    "dragonbones_assets/duesa_tex.png",
    "dragonbones_assets/oozetar_tex.png",
    "dragonbones_assets/slimebasic_tex.png",
    "dragonbones_assets/karkinos_tex.png",
    "dragonbones_assets/slimeattacker_tex.png",
    "dragonbones_assets/blademaster_tex.png",
    "dragonbones_assets/thefallen_tex.png",
    "dragonbones_assets/leviathanhogfather_tex.png",
    "img/system/window3.png",
...
Decrypter.checkImgIgnore = function (url) {
    ...
    for (let cnt = 0; cnt < this._ignoreList.length; cnt++) {
        if (lc_url.endsWith(this._ignoreList[cnt])) {
            return true;
        }
    }
    return false;
